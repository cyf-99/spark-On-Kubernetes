...
def run_spark_app_kube(userID, code_name=None, user_data=None, memory_size=1, cores_num=1):
    ...
    client = Client("http://192.168.10.6:50070")
    ...
    code_path = "hdfs://192.168.10.6:9000/spark_user/"+ userID + '/code/' + code_name
    data_path = "hdfs://192.168.10.6:9000/spark_user/"+ userID + '/data/' + code_name
